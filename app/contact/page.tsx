        ...
        <div className="p-6 md:p-10 lg:p-12 xl:pl-[52px] flex flex-col gap-10 lg:gap-14" style={{ background: '#fff', borderRight: undefined }}>
          ...
          <div className="flex flex-col gap-5">
            {[
              ...
              { icon: <><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z"/><circle cx="12" cy="10" r="3"/></>, label: 'Address', value: '45 St Marys Road, Ealing, London W5 5RG', href: 'https://maps.google.com/?q=45+St+Marys+Road+Ealing+London' },
            ].map(item => (
