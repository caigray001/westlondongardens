...
export default function ContactCTA() {
  const [formState, setFormState] = useState({ company: '', name: '', email: '', phone: '', message: '' })
  ...
  return (
    <section className="px-5 md:px-[52px] pt-16 md:pt-[100px] pb-0" style={{ background: '#f5f4f0' }}>
      <div className="max-w-[1360px] mx-auto">
        ...
        <div className="mb-10 md:mb-16 text-center">
          ...
          <p className="mx-auto" style={{
            fontSize: 16, color: '#5a5e52', lineHeight: 1.7, maxWidth: 520,
          }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.4fr_1fr] gap-[2px] mb-[2px]">

          {/* LEFT — contact details */}
          <div className="p-6 md:p-8 lg:p-10 flex flex-col gap-8" style={{ background: '#1e3d20' }}>
            <div>
              <div style={{
              ...
              {[
                {
                  ...
                  label: 'Phone', value: '020 3000 0000', href: 'tel:02030000000',
                },
                {
                  icon: <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />,
                  label: 'Email', value: 'admin@greencrowngrounds.co.uk', href: 'mailto:admin@greencrowngrounds.co.uk',
                },
                {
                ...
                <a key={item.label} href={item.href}
                  ...
                  style={{ display: 'flex', gap: 14, alignItems: 'flex-start', marginBottom: 24, textDecoration: 'none' }}
                >
                  <div style={{
                    width: 36, height: 36, background: 'rgba(255,255,255,0.1)', borderRadius: 2,
            ...
            <div style={{ borderTop: '1px solid rgba(255,255,255,0.12)', paddingTop: 28 }}>
              ...
              {[
                ...
                <div key={row.day} style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8, fontSize: 13 }}>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                {boroughs.map(b => (
                  <span key={b} style={{
                    ...
                    background: 'rgba(255,255,255,0.08)', padding: '3px 9px', borderRadius: 2,
                  }}>
                    {b}
                  </span>
                ))}
          ...
          {/* CENTRE — contact form */}
          <div className="p-6 md:p-8 lg:p-11" style={{ background: '#fff' }}>
            ...
            {submitted ? (
              <div style={{ padding: '40px 32px', background: '#e8f0e8', borderRadius: 2, textAlign: 'center' }}>
                <div style={{ fontSize: 32, marginBottom: 12 }}>✓</div>
                <div style={{ fontSize: 16, fontWeight: 700, color: '#1e3d20', marginBottom: 8 }}>Message received</div>
                <div style={{ fontSize: 14, color: '#5a5e52' }}>We&apos;ll be in touch within one business day.</div>
              </div>
            ) : (
                ...
                {[
                  ...
                  <div key={field.id}>
                    ...
                    <input
                      ...
                      style={{
                        width: '100%', padding: '11px 14px', border: '1.5px solid #e8e4dc', borderRadius: 2,
                        fontSize: 14, color: '#1a1a1a', outline: 'none', background: '#fafaf8',
      ...
      {/* FOOTER */}
      <footer className="px-5 md:px-[52px] py-8 md:py-12 mt-[2px]" style={{ background: '#111f12' }}>
